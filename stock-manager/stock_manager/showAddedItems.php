        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="addItem.php?idcom=<?= $_GET['idcom'] ?>" class="btn btn-primary" style="margin-left: 87%;">Add an item</a>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $it->qte_produit ?></td>
                                    <td><a href="delItem.php?idcom=<?= $_GET['idcom'] ?>&idpro=<?= $it->idpro ?>"><i class="bi bi-trash-fill text-dark"></a></td>
                                </tr>
