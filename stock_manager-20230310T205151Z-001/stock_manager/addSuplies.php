            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST" action="suply.php" enctype="multipart/form-data">
                            <div class="col-12">
                            ...
                            <div class="col-12"> <label for="inputNanme4" class="form-label"></label>
                                <input type="hidden" class="form-control" name="idappro" id="inputNanme4">
                            </div>

                            <div class="col-12"> <label for="inputNanme4" class="form-label">Date</label>
                                <input type="date" class="form-control" name="datea" id="inputNanme4">
                            </div>
