        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li> <a href="showClient.php"> <i class="bi bi-circle"></i><span>Show clients</span> </a></li>
                    <li> <a href="addClient.php"> <i class="bi bi-circle"></i><span>Add a client</span> </a></li>
                </ul>
            </li>
            <li class="nav-item">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Modify a Category</h5>
                            <form class="row g-3" method="POST" action="modifyCat.php">
                                <div class="col-12"> <label for="inputNanme4" class="form-label">Category</label>
                                    <input value="<?= $c->nomcat ?>" type="text" class="form-control" name="nomcat" id="inputNanme4">
                                </div>
                                <div class="col-12"> <label for="inputNanme4" class="form-label"></label>
                                    <input value="<?= $c->idcat ?>" type="hidden" class="form-control" name="idcat" id="inputNanme4">
                                </div>
