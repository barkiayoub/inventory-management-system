            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST" action="detail.php" enctype="multipart/form-data">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="hidden" class="form-control" name="idappro" value="<?= $_GET['idappro'] ?>" id="inputNanme4">
                            </div>

                            <div class="col-12"> <label for="inputNanme4" class="form-label">Quantity</label>
                                <input type="text" class="form-control" name="qta_pro" id="inputNanme4">
                            </div>
